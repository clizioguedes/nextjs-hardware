...
import { ssdFilterParsers } from "@/lib/pcbuildwizard/search-params";
...
// No Fabricante fieldset here: the manufacturer list this category returns
// is mostly GPU brand names, not real SSD makers, so this only filters by Loja.
export function FilterPanel({ merchants }: FilterPanelProps) {
  ...
  const [filters, setFilters] = useQueryStates(ssdFilterParsers, {
    shallow: false,
    startTransition,
  });
