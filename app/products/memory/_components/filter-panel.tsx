...
import { MemoryStickIcon, SlidersHorizontalIcon, StoreIcon } from "lucide-react";
...
import { memoryFilterParsers } from "@/lib/pcbuildwizard/search-params";
...
export function FilterPanel({ merchants, manufacturers }: FilterPanelProps) {
  ...
  const [filters, setFilters] = useQueryStates(memoryFilterParsers, {
    shallow: false,
    startTransition,
  });
