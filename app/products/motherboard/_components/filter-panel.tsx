...
import { CircuitBoardIcon, SlidersHorizontalIcon, StoreIcon } from "lucide-react";
...
import { motherboardFilterParsers } from "@/lib/pcbuildwizard/search-params";
...
export function FilterPanel({ merchants, manufacturers }: FilterPanelProps) {
  ...
  const [filters, setFilters] = useQueryStates(motherboardFilterParsers, {
    shallow: false,
    startTransition,
  });
