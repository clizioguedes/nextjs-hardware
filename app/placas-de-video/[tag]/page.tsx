...
import { getVideoCardByTag } from "@/lib/pcbuildwizard/video-cards";
import { RequestError } from "@/lib/request";
import { RefreshPriceButton } from "@/app/placas-de-video/[tag]/_components/refresh-price-button";
import { CouponBadge } from "@/app/placas-de-video/_components/coupon-badge";
import { ProductImage } from "@/app/placas-de-video/_components/product-image";
import { StarRating } from "@/app/placas-de-video/_components/star-rating";
import { SetBreadcrumbLabel } from "@/components/set-breadcrumb-label";

const currency = new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL" });

export default async function VideoCardDetailPage(props: PageProps<"/placas-de-video/[tag]">) {
  const { tag } = await props.params;

  let product;
  try {
    product = await getVideoCardByTag(tag);
  } catch (error) {
