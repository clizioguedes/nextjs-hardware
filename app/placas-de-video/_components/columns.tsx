...
import type { ColumnDef } from "@/app/placas-de-video/_components/data-table";
...
export const videoCardColumns: ColumnDef<VideoCardProduct>[] = [
  {
    id: "product",
    header: "Produto",
    cell: ({ row }) => {
    ...
    cell: ({ row }) => (
      <Tooltip>
        <TooltipTrigger
          render={
            <Link
              href={`/placas-de-video/${row.original.tag}`}
